...
export const GAMES = [
 {id:'auction',maxAll:8,name:'Food Auction',short:'Food Auction',icon:'$',color:'#ffd166',ink:'#493018',min:2,formats:['spot'],label:'Bid · build · pitch',description:'Bid on restaurants. Build a four-part meal.'},
 ...
 {id:'draft',maxAll:8,name:'Food Court Draft',short:'Food Draft',icon:'≋',color:'#f1c778',ink:'#573c16',min:2,formats:['spot'],label:'Create · reveal · vote',description:'Draft your dream meal. Win the room.'},
