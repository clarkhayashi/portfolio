...
export const GAMES = [
 ...
 {id:'brain',name:'Same Brain?',short:'Same Brain',icon:'◎',color:'#8acbd2',ink:'#163c46',min:2,formats:['all'],label:'Everyone plays',description:'Think alike. Match a friend’s answer. At 4+ players, pick a side in Herd rounds.',herd:'At 4+ players, every other round is a Herd round: one player writes a this-or-that, everyone picks a side, the smaller side loses. Be the only one on your side and you’re the 🐑 Black Sheep. If everyone agrees, the writer pays for making it too easy.'},
