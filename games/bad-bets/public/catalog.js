export const GAMES = [
 {id:'auction',name:'Food Auction',short:'Food Auction',icon:'$',color:'#ffd166',ink:'#493018',min:2,formats:['spot'],label:'Bid · build · pitch',description:'Bid on restaurants. Build a four-part meal.'},
 ...
 {id:'draft',name:'Food Court Draft',short:'Food Draft',icon:'≋',color:'#f1c778',ink:'#573c16',min:2,formats:['spot'],label:'Create · reveal · vote',description:'Draft your dream meal. Win the room.'},
 {id:'draw',name:'Drawn Into Trouble',short:'Draw Trouble',icon:'✎',color:'#eea99c',ink:'#562c29',min:2,formats:['spot'],label:'Create · reveal · vote',description:'Terrible drawings. Excellent arguments.'},
