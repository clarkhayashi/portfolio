// Original prompts. Deck names describe the room's chosen tone.
const ice=[
 ['Share','What tiny inconvenience would you erase from the world?'],
 ['Either / Or','Your weekend gets one upgrade. Which one?',['A personal chef','A teleport home button']],
 ['Play','Pitch a wildly unnecessary invention in one sentence.'],
 ['Share','What is a harmless opinion you will defend far too enthusiastically?'],
 ['Either / Or','Pick your ridiculous superpower.',['Understand every dog','Always pick the best menu item']],
 ['Play','Give the person after you a fictional job title based on their vibe. Keep it kind.'],
 ['Share','What ordinary thing makes a day feel special to you?'],
 ['Either / Or','Choose your group adventure.',['Mystery road trip','Backyard food festival']],
 ['Play','Describe your week as the title of a very dramatic movie.'],
 ['Share','What snack deserves a standing ovation?'],
 ['Either / Or','You get one free class.',['Cooking something incredible','Dancing with confidence']],
 ['Play','Invent a terrible slogan for a very good product.']
];
const deeper=[
 ...
 ['Share','What is a belief about yourself you have outgrown?'],
 ['Either / Or','How do you usually show you care?',['Doing something helpful','Saying what someone means to you']],
 ['Play','Name a small win from this week. The room supplies the applause.'],
 ['Share','What is something you wish people asked you about more often?'],
