...
**Activation predicts return, and the unit that matters is a league, not a game.** One league runs about four to five weeks including playoffs, so the game counts translate directly: one or two games means quitting partway through a single league, three to five is finishing one, six to ten is two leagues, and eleven or more is three. Return the following year climbs at every step, across 2,430 new players: 23 percent, 49 percent, 66 percent, 84 percent. A student who comes back for a second league is close to three times as likely to keep playing as one who never finished their first, and by a third league it is closer to four. Playing a second sport moves return from 41 percent to 64 percent on its own. The practical version is either the same sport across the year, the way soccer runs all three quarters, or different sports stacked through it, flag football in fall and spring with basketball in winter. Motivated players both play more and return more, so this is a leading indicator rather than a proven lever, but it tells staff exactly what to aim at.
...
- Aim new-player communication at finishing the first league and entering a second, rather than at the initial signup, and protect new-player leagues from the forfeits that truncate a first season early.
- Point returning players at a path that keeps them playing across the year: the same sport where it runs every quarter, or a second sport in the quarters their first one does not cover.
