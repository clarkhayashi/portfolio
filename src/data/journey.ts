...
export const journey: JourneyStop[] = [
  ...
  },
  {
    ...
    story:
      "I have always wanted to go to Europe, so when this opportunity came along, I could not pass it up. Italy felt completely new compared with anything I had experienced before. I went in not knowing anyone, but I left making lifelong friends. The class brought together MBA students and younger undergrads. As a senior, I was somewhere in the middle: asking people who had already built careers for advice, while sharing some of what I had learned with students just starting out. At the family-run places, the care was impossible to miss. You could feel the pride, history, and personal care behind the product. Seeing that level of craft alongside companies operating at global scale made all the preparation work from spring and summer feel real.",
